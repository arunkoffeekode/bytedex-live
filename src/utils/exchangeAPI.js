...
export class ExchangeApi {
  ...
  authenticatedCall = async ({ url, method = "GET", headers = {}, data }) => {
  ...
  addOnIPWhitelist = async ({ cidr, type }) => {
    return await this.authenticatedCall({
      method: "POST",
  ...
  removeFormIPWhitelist = async ({ cidr, type }) => {
    return await this.authenticatedCall({
      method: "POST",
  ...
  removeFormDeviceWhitelist = async ({ id }) => {
    return await this.authenticatedCall({
      method: "POST",
