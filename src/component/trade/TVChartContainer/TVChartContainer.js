...
import { widget } from "../../charting_library/charting_library.standalone.js";
...
class TVChartContainer extends React.PureComponent {
  ...
  updateTheme() {
    const styleElement =
      this.tvWidget._iFrame.contentDocument.documentElement.style;
  ...
  render() {
    return <ChartWrapper id={this.props.containerId} />;
  }
}
