...
import { formatCrypto, getDecimalPrecision } from "../../utils/numbers";
import { initializeThemes, triggerModalOpen } from "../actions/ui";
import { setNumberFormat } from "../actions/userSettings";
...
const formatSettings = async (settings, overrides) => {
  ...
  return {
    ...
    enableMgOkEx: isTrue(enable_MgOkEx),
