...
import instance, { authenticatedInstance } from "../../utils/api";
import { triggerToast, triggerModalOpen } from "../actions/ui";
import { getRateList } from "../selectors/markets";
...
export const LOAD_DERIVATIVES_PORTFOLIO_STARTED =
  "LOAD_DERIVATIVES_PORTFOLIO_STARTED";
export const LOAD_DERIVATIVES_PORTFOLIO_SUCCESS =
  "LOAD_DERIVATIVES_PORTFOLIO_SUCCESS";
export const LOAD_DERIVATIVES_PORTFOLIO_FAIL =
...
export const initializePortfolio = (data) => {
  return async (dispatch, getState) => {
    ...
    if (
      Object.keys(currencySettings).length === 0 &&
      currencySettings.constructor === Object
    ) {
