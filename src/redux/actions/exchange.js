...
import { UPDATE_EXCHANGE_DATA } from "../actions/markets";
import { getTradeHistory } from "../selectors/exchange";
import { getSingleTradingPairSettings } from "../selectors/settings";
...
const formatTradeHistory = (tradeHistoryItem) => {
  ...
  return {
    time: moment.utc(timestamp).local().format("HH:mm:ss"),
    side: execution_side,
    price: rate,
    volume,
    id,
