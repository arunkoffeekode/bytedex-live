                    ...
                    <form>
                      <div className="form-row">
                        <div className="form-group col-md-12">
                          ...
                          <h6>
                            Image file format must be jpg or png, file size
                            cannot exceed 4 MB. Image should be clearly visible!
                            Note should be clearly readable!{" "}
                          </h6>
                        </div>
...
export default Kycverification4;
